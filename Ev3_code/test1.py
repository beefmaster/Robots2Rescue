...
while drivetrain.on(steering=0, speed=10):
    if ultrasonic_sensor.distance_centimeters>2.0:
        #rotates robot on the spot for 360 degrees
        drivetrain.on(steering=100, speed=-20)
        
   
medium_motor.on_for_degrees(speed=0, degree=0)
medium_motor.drive(speed=10, degree=0)
